...
var tour_bubbles = [
    {
        ...
        center: true,
        element: '.blue-box',
        text: 'This is the credit goal, in the first box you enter how many points you want to increase your credit score by.',
        button: '<br/><button data-role="none" onclick="advance_tour = true;">Continue</button>',
        hasaction: true,
        action: function(){ $('#credit-points').trigger('focus'); }
    },
    {
        bottom: 180,
        posy: 'top',
        ...
        center: true,
        element: '.blue-box',
        text: 'In the second box, you enter the time period (1,2,3,etc...) which you would like to increase your credit score by.',
        button: '<br/><button data-role="none" onclick="advance_tour = true;">Continue</button>',
        hasaction: true,
        action: function(){ $('#credit-period').trigger('focus'); }
    },
    {
        bottom: 180,
        posy: 'top',
        ...
        center: true,
        element: '.blue-box',
        text: 'In the third box, you enter the time scale which you would like to increase your credit score over.',
        button: '<br/><button data-role="none" onclick="advance_tour = true;">Continue</button>',
        hasaction: true,
        action: function(){ $('#credit-time').trigger('focus') }
    },
    {
        bottom: 180,
        posy: 'top',
        ...
        finish: true,
        hasaction: true,
        action: function(){ $('#blue-btn').trigger('focus'); }
    }
];
